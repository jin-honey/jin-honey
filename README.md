...
- 심박수 이상 탐지 및 심박수 기반 건강 점수 산정 시스템
  - 등록 번호: C-2025-021655
  - 설명: 심박수 시계열 데이터 기반 Attention 메커니즘을 활용한 정교한 이상 탐지 및 손실 값 기반 건강 점수 산정 프로그램.
...
- 웨어러블 건강 데이터 기반 다중 데이터 분석 및 개인 맞춤 피드백 생성 시스템
  - 등록 번호: C-2025-022114
  - 설명: 시계열 데이터, 수치형 데이터, 범주형 데이터 통합 이상 탐지 후 가중 손실 거리 기반 점수 산정 및 RAG 건강 피드백 생성 프로그램.
- 비전-언어 모델 기반 시각-텍스트 특징 논리적 이상 탐지 시스템
  - 등록 번호: C-2025-055470
  - 설명: 비전-언어 모델 기반 학습 없는 설명 가능한 이상 탐지 시스템.
